...
class ControllerInstallStep3 extends Controller {
    ...
    public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            $output .= 'define(\'HTTP_SERVER\', \'http://\' . $host. \'/\');' . "\n\n";

            $output .= '// HTTPS' . "\n";
            $output .= 'define(\'HTTPS_SERVER\', \'https://\' . $host. \'/\');' . "\n\n";

            $output .= '// DIR' . "\n";
            $output .= '$dir = dirname(__FILE__);' . "\n";
            $output .= 'define(\'DIR_APPLICATION\', $dir . \'/catalog/\');' . "\n";
            $output .= 'define(\'DIR_SYSTEM\', $dir . \'/system/\');' . "\n";
            $output .= 'define(\'DIR_IMAGE\', $dir . \'/image/\');' . "\n";
            ...
            $output .= '// HTTP' . "\n";
            $output .= '$host = $_SERVER[\'HTTP_HOST\'];' . "\n";
            $output .= 'define(\'HTTP_SERVER\', \'http://\' . $host. \'/admin/\');' . "\n";
            $output .= 'define(\'HTTP_CATALOG\', \'http://\' . $host. \'/\');' . "\n\n";

            $output .= '// HTTPS' . "\n";
            $output .= 'define(\'HTTPS_SERVER\', \'https://\' . $host. \'/admin/\');' . "\n";
            $output .= 'define(\'HTTPS_CATALOG\', \'https://\' . $host. \'/\');' . "\n\n";

            $output .= '// DIR' . "\n";
            $output .= '$dir = dirname(dirname(__FILE__));' . "\n";
            $output .= 'define(\'DIR_APPLICATION\', $dir . \'/admin/\');' . "\n";
            $output .= 'define(\'DIR_SYSTEM\', $dir . \'/system/\');' . "\n";
            $output .= 'define(\'DIR_IMAGE\', $dir . \'/image/\');' . "\n";
            $output .= 'define(\'DIR_STORAGE\', DIR_SYSTEM . \'storage/\');' . "\n";
            $output .= 'define(\'DIR_CATALOG\', $dir . \'/catalog/\');' . "\n";
            $output .= 'define(\'DIR_LANGUAGE\', DIR_APPLICATION . \'language/\');' . "\n";
