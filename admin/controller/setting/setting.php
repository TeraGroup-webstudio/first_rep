...
class ControllerSettingSetting extends Controller {
    ...
    public function index() {
        ...
        if (isset($this->request->post['config_number'])) {
            $numbers = $this->request->post['config_number'];
        } else {
            $numbers = $this->config->get('config_number');
        }

        $data['config_numbers'] = array();
        ...
        if (isset($this->request->post['config_messager'])) {
            $messagers = $this->request->post['config_messager'];
        } else {
            $messagers = $this->config->get('config_messager');
        }

        $data['config_messagers'] = array();
        if($messagers){
            foreach ($messagers as $item) {
        ...
        if (isset($this->request->post['config_open_b'])) {
            $data['config_open_b'] = $this->request->post['config_open_b'];
        } else {
            $data['config_open_b'] = $this->config->get('config_open_b');
        }

        if (isset($this->request->post['config_open_v'])) {
            $data['config_open_v'] = $this->request->post['config_open_v'];
        } else {
            $data['config_open_v'] = $this->config->get('config_open_v');
        }
        ...
        if (isset($this->request->post['config_maps'])) {
            $data['config_maps'] = $this->request->post['config_maps'];
        } else {
            $data['config_maps'] = $this->config->get('config_maps');
        }
        ...
        $data['config_sale_customers'] = array();

        if (isset($this->request->post['config_sale_customer'])) {
            $results_sale = $this->request->post['config_sale_customer'];
        } else {
            $results_sale = $this->config->get('config_sale_customer');
        }
        ...
        if (isset($this->request->post['config_manufacturer_exception'])) {
            $data['config_manufacturer_exception'] = $this->request->post['config_manufacturer_exception'];
        } else {
            $data['config_manufacturer_exception'] = $this->config->get('config_manufacturer_exception');
        }
        ...
        $data['list_manufacturer'] = $this->model_catalog_manufacturer->getManufacturers();
    ...
    protected function validate() {
        ...
        foreach ($this->request->post['config_meta_title'] as $language_id => $value) {
            if ((utf8_strlen($value) < 1) || (utf8_strlen($value) > 255)) {
                $this->error['meta_title'][$language_id] = $this->language->get('error_meta_title');
            }
        }

        foreach ($this->request->post['config_address'] as $language_id => $value) {
            if ((utf8_strlen($value) < 1) || (utf8_strlen($value) > 255)) {
