<?php
// Heading
$_['heading_title']      = 'Импорт XML';
$_['heading_ico']      = '<svg height="800px" width="800px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
...
$_['text_start']     = 'Импортировать';
$_['text_result']     = 'Результат';


$_['entry_status']     = 'Cтатус';
$_['entry_type_download']     = 'Тип загрузки';
$_['entry_setting_category']     = 'Настройки категорий';
$_['entry_setting_product']     = 'Настройки товаров';
$_['entry_setting_category_status']     = 'Включить импорт данных по категории';
$_['entry_setting_product_status']     = 'Включить импорт данных по товарах';

$_['button_file']     = 'Файл';
$_['button_url']     = 'Ссылка';


$_['help_type_download']     = 'Либо с файла, либо по ссылке. Если настроен крон то он будет работать если только выбран вариант по ссылке';
$_['help_setting_category']     = 'Настройки по импорту данных категорий';
